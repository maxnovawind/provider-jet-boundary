...
import (
	...
	v1alpha1 "github.com/maxnovawind/provider-jet-boundary/apis/scope/v1alpha1"
...
func (mg *Role) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		CurrentValue: reference.FromPtrValue(mg.Spec.ForProvider.GrantScopeID),
		Extract:      reference.ExternalName(),
		Reference:    mg.Spec.ForProvider.GrantScopeIDRef,
		Selector:     mg.Spec.ForProvider.GrantScopeIDSelector,
		To: reference.To{
	...
	if err != nil {
		return errors.Wrap(err, "mg.Spec.ForProvider.GrantScopeID")
	}
	mg.Spec.ForProvider.GrantScopeID = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.ForProvider.GrantScopeIDRef = rsp.ResolvedReference
